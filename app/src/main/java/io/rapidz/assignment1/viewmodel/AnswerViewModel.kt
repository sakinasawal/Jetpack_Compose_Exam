...
//		viewModelScope.launch {
//			val loadedAnswers = answerRepository.getAnswersForCandidate(candidateId)
//			_answers.clear()
...
//}
//
//class AnswerViewModelFactory(private val answerRepository : AnswerRepository) : ViewModelProvider.Factory {
